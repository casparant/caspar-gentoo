...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/wine/wine-1.0.1.ebuild,v 1.3 2009/08/26 21:57:56 vapier Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-FT_MulFix.patch #262639
	epatch "${FILESDIR}"/${PN}-charset-936.patch #Chinese font
	epatch_user #282735
