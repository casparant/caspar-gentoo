...
if [[ ${PV} == "9999" ]]; then
	...
	WIZNOTE_SRC_URI="https://github.com/WizTeam/WizQTClient/archive/v${PV/_beta/-beta}.tar.gz -> ${P}.tar.gz"
	RESTRICT="mirror"
...
SLOT="0"
IUSE=""
PATCHES=( "${FILESDIR}/fix-ioapi.patch" "${FILESDIR}/asyncapi.patch" "${FILESDIR}/systray.patch" )
