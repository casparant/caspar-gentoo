...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-8.1.14-initscript.patch
	epatch "${FILESDIR}"/${PN}-8.1.14-no-exampledir.patch
	epatch "${FILESDIR}"/${PN}-8.1.14-oldkrb.patch
	epatch "${FILESDIR}"/${PN}-manperms.patch
}
