...
src_prepare() {
	...
	#Ubuntu patches
	epatch "${FILESDIR}"/00_old_diff_gz.patch
	epatch "${FILESDIR}"/04_ubuntu_monospace_lcd_filter_conf.patch
	epatch "${FILESDIR}"/05_lcdfilterlegacy.patch
	epatch "${FILESDIR}"/05_ubuntu_add_hinting_and_antialiasing_confs.patch
	epatch "${FILESDIR}"/06_ubuntu_lcddefault.patch
	epatch "${FILESDIR}"/07_no_bitmaps.patch
